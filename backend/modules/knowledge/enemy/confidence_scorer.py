"""Confidence scoring for enemy-force assessments.

Produces a final confidence score by combining detection confidence,
intelligence-source confidence, and evidence strength.  The weighting
...
from backend.modules.knowledge.enemy.exceptions import ScoringError
from backend.modules.knowledge.enemy.interfaces import (
    ConfidenceScorerInterface,
    Evidence,
)

logger = logging.getLogger("dss.knowledge.enemy.confidence_scorer")
