"""Friendly Knowledge module configuration.

All values are overridable via environment variables prefixed with ``FRIENDLY_``.
"""

from pydantic_settings import BaseSettings


class FriendlyConfig(BaseSettings):
    """Configuration for the Friendly Knowledge pipeline.

    Controls retrieval, evidence, scoring, and future vector-database
    connection parameters.
    """

    model_config = {"env_prefix": "FRIENDLY_"}
    ...
    vector_db_collection: str = "friendly_knowledge"
...
friendly_config = FriendlyConfig()
